...
class TestDictionaryEntity:
    ...
    def test_update_info_with_all_fields(self):
        ...
        dictionary.update_info(
            name="new-gender", label="女", value="2", sort=2, is_active=1, parent_id="parent-1", description="描述"
        )
    ...
    def test_create_new(self):
        ...
        dictionary = DictionaryEntity.create_new(
            name="gender", label="男", value="1", sort=1, parent_id="parent-1", description="性别字典"
        )
