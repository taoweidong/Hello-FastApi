...
-- ----------------------------
-- Table structure for sys_departments (无外部依赖，自引用)
-- ----------------------------
...
-- ----------------------------
-- Table structure for sys_roles (无外部依赖)
-- ----------------------------
...
-- ----------------------------
-- Table structure for sys_users (依赖 sys_departments)
-- ----------------------------
...
-- ----------------------------
-- Table structure for sys_menumeta (无外部依赖)
-- ----------------------------
...
-- ----------------------------
-- Table structure for sys_menus (依赖 sys_menumeta, 自引用)
-- ----------------------------
...
-- ----------------------------
-- Table structure for sys_userinfo_roles (依赖 sys_users, sys_roles)
-- ----------------------------
...
-- ----------------------------
-- Table structure for sys_userrole_menu (依赖 sys_roles, sys_menus)
-- ----------------------------
...
-- ----------------------------
-- Table structure for sys_logs (无外部依赖)
-- ----------------------------
...
-- ----------------------------
-- Table structure for sys_userloginlog (无外部依赖)
-- ----------------------------
...
-- ----------------------------
-- Table structure for sys_systemconfig (无外部依赖)
-- ----------------------------
...
-- ----------------------------
-- Table structure for sys_ip_rules (无外部依赖)
-- ----------------------------
