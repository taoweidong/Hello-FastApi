...
DEFAULT_MENUS = [
    # === 系统管理目录 ===
    {
        ...
        "menu_type": 0,
        "rank": 1,
        "meta": {"title": "系统管理", "icon": "ri:settings-3-line"},
    },
    # --- 用户管理 ---
    {
        "name": "User",
        ...
        "description": "管理系统用户账号，支持新增、编辑、删除及角色分配",
    },
    ...
    # --- 角色管理 ---
    {
        ...
        "rank": 2,
        "parent_id": "System",
        "meta": {"title": "角色管理", "icon": "ri:admin-fill"},
        "description": "管理系统角色定义及菜单权限分配",
    },
    ...
    # --- 部门管理 ---
    {
        ...
        "rank": 4,
        "parent_id": "System",
        "meta": {"title": "部门管理", "icon": "ri:git-branch-line"},
        "description": "管理组织架构部门层级及人员归属",
    },
    ...
    # --- 字典管理 ---
    {
        ...
        "rank": 5,
        "parent_id": "System",
        "meta": {"title": "字典管理", "icon": "ri:book-read-line"},
        "description": "管理系统业务字典数据，支持树形层级结构",
    },
    {
    ...
    # --- IP规则 ---
    {
        "name": "IpRule",
        "path": "/system/ip-rule",
        "component": "system/ip-rule/index",
        "menu_type": 1,
        "rank": 5,
        "parent_id": "System",
        "meta": {"title": "IP规则", "icon": "ri:shield-keyhole-line"},
        "description": "配置 IP 白名单或黑名单访问控制规则",
    },
    ...
    # --- 系统配置 ---
    {
        ...
        "rank": 6,
        "parent_id": "System",
        "meta": {"title": "系统配置", "icon": "ri:settings-4-line"},
        "description": "管理系统全局参数及运行配置",
    },
    ...
    # === 系统监控目录 ===
    {
        ...
        "menu_type": 0,
        "rank": 2,
        "meta": {"title": "系统监控", "icon": "ep:monitor"},
    },
    # --- 在线用户 ---
    {
        "name": "OnlineUser",
        ...
        "rank": 1,
        "parent_id": "Monitor",
        "meta": {"title": "在线用户", "icon": "ri:user-voice-line"},
        "description": "查看当前在线用户列表，支持强制下线操作",
    },
    # --- 日志管理 ---
    {
        "name": "Log",
        ...
        "rank": 2,
        "parent_id": "Monitor",
        "meta": {"title": "日志管理", "icon": "ri:file-list-line"},
    },
    {
        "name": "LoginLog",
        ...
        "rank": 1,
        "parent_id": "Log",
        "meta": {"title": "登录日志", "icon": "ri:window-line"},
        "description": "查询用户登录历史记录及登录状态统计",
    },
    {
        "name": "OperationLog",
        ...
        "rank": 2,
        "parent_id": "Log",
        "meta": {"title": "操作日志", "icon": "ri:history-fill"},
        "description": "查询用户操作行为日志及接口调用记录",
    },
