...
DEFAULT_MENUS = [
    ...
    # --- 通知公告 ---
    {
        ...
        "rank": 7,
        "parent_id": "System",
        "meta": {"title": "通知公告", "icon": "ri:notification-line"},
        "description": "管理系统通知公告，支持发布、编辑与关闭",
    },
    {"name": "notice:view", "path": "/system/notice", "menu_type": 2, "method": "GET", "parent_id": "Notice"},
    {"name": "notice:add", "path": "/system/notice", "menu_type": 2, "method": "POST", "parent_id": "Notice"},
    {"name": "notice:edit", "path": "/system/notice", "menu_type": 2, "method": "PUT", "parent_id": "Notice"},
    {"name": "notice:delete", "path": "/system/notice", "menu_type": 2, "method": "DELETE", "parent_id": "Notice"},
    # --- 岗位管理 ---
    {
        "name": "Post",
        "path": "/system/post",
        ...
        "rank": 8,
        "parent_id": "System",
        "meta": {"title": "岗位管理", "icon": "ri:id-card-line"},
        "description": "管理岗位定义，支持为用户分配岗位",
    },
    {"name": "post:view", "path": "/system/post", "menu_type": 2, "method": "GET", "parent_id": "Post"},
    {"name": "post:add", "path": "/system/post", "menu_type": 2, "method": "POST", "parent_id": "Post"},
    {"name": "post:edit", "path": "/system/post", "menu_type": 2, "method": "PUT", "parent_id": "Post"},
    {"name": "post:delete", "path": "/system/post", "menu_type": 2, "method": "DELETE", "parent_id": "Post"},
    # === 系统监控目录 ===
    {
        "name": "Monitor",
        "path": "/monitor",
    ...
    # --- 服务器监控 ---
    {
        ...
        "rank": 2,
        "parent_id": "Monitor",
        "meta": {"title": "服务器监控", "icon": "ri:server-line"},
        "description": "查看服务器 CPU、内存、磁盘与进程实时状态",
    },
    # --- 缓存监控 ---
    {
        "name": "CacheMonitor",
        ...
        "rank": 3,
        "parent_id": "Monitor",
        "meta": {"title": "缓存监控", "icon": "ri:database-2-line"},
        "description": "查看 Redis 缓存连接、内存与键统计信息",
    },
    # --- 日志管理 ---
    {
        "name": "Log",
    ...
    # === 权限演示目录 ===
    {
        ...
        "menu_type": 0,
        "rank": 3,
        "meta": {"title": "权限管理", "icon": "ep:lollipop"},
    },
    # --- 页面权限 ---
    {
        "name": "PermissionPage",
        ...
        "meta": {"title": "页面权限", "icon": "ri:window-2-line"},
        "description": "演示不同角色可见的页面级权限控制",
    },
    # --- 按钮权限 ---
    {
        ...
        "rank": 2,
        "parent_id": "Permission",
        "meta": {"title": "按钮权限", "icon": "ri:button-line"},
        "description": "演示按钮级别的权限控制（meta.auths）",
    },
    {
    ...
    # --- 按钮权限（组件方式） ---
    {
        ...
        "rank": 3,
        "parent_id": "Permission",
        "meta": {"title": "按钮权限组件", "icon": "ri:components-line"},
        "description": "演示通过 Perms 组件控制按钮可见性",
    },
]
